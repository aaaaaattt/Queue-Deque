class PriorityQueue :
    ...
    def isFull(self) : return self.size == self.capacity #포화상태 = 요소의 수가 capacity랑 같다
    ...
    def findMaxIndex(self) :        #우선순위 구하는 메소드
            ...
            for i in range(1, self.size) :
                if self.array[i][2] > self.array[highest][2] : #공백이 아니면 우선순위가 가장 높은 요소의 인덱스 highest를 구해반환
                    highest = i
            return highest
